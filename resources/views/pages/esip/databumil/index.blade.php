...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">LAPORAN DATA IBU HAMIL KEK (LILA < 23,5 CM)</li>
  </ol>
</nav>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Nama Suami" name="nama_ayah" required>
                        </div>
                    </div>
                    <!-- Col -->
                    <div class="col-sm-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Nama Ibu Hamil" name="nama_ibu" required>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="mb-3">
                            <label class="form-label">Umur Kehamilan</label>
                            <input type="text" class="form-control" placeholder="Umur Kehamilan" name="nama_ibu" required>
                        </div>
                    </div>
                    <!-- Col -->
                </div>
