...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">REGISTER BALITA DALAM WILAYAH KERJA POSYANDU JANUARI S/D DESEMBER</li>
  </ol>
</nav>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content p-4">
            ...
            <form class="forms-sample" action="{{ route('warga.store') }}" method="POST" id="formWarga"> 
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Nama Lengkap Anak" name="nama_bayi" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Nama Lengkap Bayi" name="nama_bayi">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">KLP Dasa Wisma</label>
                            <input type="text" class="form-control" name="">
                        </div>
                    </div>
                </div>
                <h6>Hasil Penimbangan</h6>
                <hr>
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                ...
                <h6>Pelayanan Yang Diberikan</h6>
                <p>Sirup Besi</p>
                <hr>
                <div class="row">
                    <div class="col-md-4">
