      ...
      <div class="card-body">
        <div class="row pb-4">
            <div class="col-md-4 mb-4">
                <h6 class="card-title align-self-center">Buat Program Unggulan</h6>
                <form action="{{ route('program-unggulan.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div class="mb-3">
                            <label for="exampleInputUsername1" class="form-label">Nama Program</label>
                            <input type="text" class="form-control" id="namakategori" autocomplete="off" name="nama" placeholder="Nama Program" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-primary me-2">Buat Program Unggulan</button>
                </form>
            </div>
            <div class="col-md-8">
                <h6 class="card-title align-self-center">Data Program Unggulan</h6>
                @if(session('success'))
                ...
                <div class="table-responsive">
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            $nomor = 1;
                            @endphp
                            @foreach ($programunggulan as $data)
                        <tr>
                            <td>{{ $nomor++ }}</td>
                            <td>{{ $data->nama }}</td>
                            <td>
